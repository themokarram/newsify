...
export default class News extends Component {
  ...
  handlePrevClick = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=${
      ...
      this.props.category
    }&apiKey=4666e0ec8c754012acf2978b472a388d&page=${
      this.state.page - 1
  ...
  render() {
    return (
      <>
        ...
        >
          Today's Headlines are {this.state.loading && <CircularProgress />}
        </Typography>
        ...
        <Grid Container m={3} display={"flex"} justifyContent={"space-between"}>
          ...
          <Button
            disabled={
              this.state.page > Math.ceil(this.state.totalResults / 6) - 1
            }
            variant="contained"
